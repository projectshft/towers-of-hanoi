...
const gameMethods = {
  ...
  renderFullInstructions () {
    ...
    For example, 'move(1, 2)' will move the topmost disc from the first (topmost horizontally) peg to the second peg. 'move(3, 1)' will move from the third peg (bottommost horizontally) to the first peg.
